...
export default function TrashScreen({ navigation }) {
  ...
  const getDaysLeft = (deletedAt) => {
    const diff =
      30 -
      Math.floor((new Date() - new Date(deletedAt)) / (1000 * 60 * 60 * 24));
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: theme.bg2 }]}>
        <View style={[styles.header, { borderBottomColor: theme.border }]}>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <Text style={[styles.backBtn, { color: theme.text2 }]}>
              ← Retour
            </Text>
          </TouchableOpacity>
          <Text
            style={{ fontSize: 20, color: accent.primary, fontStyle: 'italic' }}
          >
            Corbeille
          </Text>
          <View style={{ width: 60 }} />
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg2 }]}>
        ...
        {trash.length === 0 ? (
          ...
          trash.map((note) => (
            <TouchableOpacity
              ...
              onLongPress={() => restoreNote(note.id)}
              activeOpacity={0.8}
            >
                ...
                <View style={{ flex: 1 }}>
                  <Text
                    style={[
                      styles.trashTitle,
                      {
                        color: selected.includes(note.id)
                          ? accent.primary
                          : theme.text,
                      },
                      fontsLoaded && {
              ...
              {note.contenu ? (
                <Text
                  style={[styles.trashExcerpt, { color: theme.text3 }]}
                  numberOfLines={2}
                >
                  {note.contenu}
                </Text>
      ...
      {selected.length > 0 && (
        ...
        >
          ...
          >
            <Text style={[styles.actionBtnText, { color: '#e55' }]}>
              🗑️ Supprimer
            </Text>
          </TouchableOpacity>
        </View>
      ...
      {trash.length > 0 && selected.length === 0 && (
        <View style={[styles.emptyBtn, { borderTopColor: theme.border }]}>
          ...
          >
            <Text style={[styles.emptyBtnText, { color: '#e55' }]}>
            ...
            <TouchableWithoutFeedback>
              ...
              >
                ...
                <Text style={[styles.confirmDesc, { color: theme.text2 }]}>
                  {trash.length} note(s) seront supprimées définitivement. Cette
                ...
                >
                  <Text style={[styles.confirmBtnText, { color: '#e55' }]}>
                ...
                >
                  <Text style={[styles.cancelBtnText, { color: theme.text2 }]}>
                    Annuler
                  </Text>
                </TouchableOpacity>
              </View>
