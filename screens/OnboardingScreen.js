        ...
        <View style={{ position: 'relative', width: 200, height: 160 }}>
          ...
          >
            ...
            <View style={{ flexDirection: 'row', gap: 6, marginTop: 6 }}>
              ...
              >
                <Text style={[styles.exportTagText, { color: theme.text2 }]}>
                  PDF
                </Text>
              </View>
              <View
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      >
        ...
        {slide.badge && (
          ...
          >
            <Text style={[styles.badgeText, { color: theme.text2 }]}>
              {slide.badge}
            </Text>
          </View>
        )}
        ...
        >
          <Text style={[styles.descText, { color: theme.text2 }]}>
            {slide.desc}
          </Text>
        </View>
      </Animated.View>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={[styles.nextArrow, { color: accent.primary }]}>
            {isLast ? '✓' : '→'}
          </Text>
        </TouchableOpacity>
      </View>
