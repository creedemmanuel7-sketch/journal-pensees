    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.previewWrap}>
          ...
          >
            ...
            <View style={[styles.cardHeader, { borderBottomColor: t.border }]}>
              <Text style={[styles.cardApp, { color: t.sub }]}>
                ✦ MES PENSÉES
              </Text>
            ...
            <View style={styles.cardBody}>
              <Text style={[styles.cardMood, { color: t.accent }]}>
                {note.mood || '😌'}
              </Text>
              <Text
                style={[
          ...
          {TEMPLATES.map((tp) => (
            <TouchableOpacity
              ...
              style={[
                styles.templateBtn,
                {
                  backgroundColor: TEMPLATE_STYLES[tp.key].bg,
            ...
            >
              ...
              <Text
                style={[
                  ...
                  { color: TEMPLATE_STYLES[tp.key].text },
                ]}
              >
                {tp.label}
              </Text>
        ...
        >
          ...
          <Text style={[styles.infoText, { color: theme.text2 }]}>
            La carte ne contient aucune métadonnée personnelle. Seuls le titre,
            l'extrait et la date sont visibles.
          </Text>
        </View>
      ...
      >
        <TouchableOpacity
          style={[
            styles.shareBtn,
            { backgroundColor: sharing ? theme.bg4 : accent.primary },
          ]}
          onPress={handleShare}
          disabled={sharing}
        >
          <Text
            style={[
              styles.shareBtnText,
              { color: sharing ? theme.text3 : theme.bg },
            ]}
          >
