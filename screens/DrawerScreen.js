...
export default function DrawerScreen({ navigation }) {
  ...
  const { lock } = useAuth();
  const { getActiveNotes, getTotalWords } = useNotes();
  ...
  const handleLock = () => {
    ...
    if (root) {
      root.reset({ index: 0, routes: [{ name: 'Lock' }] });
    } else {
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            ...
            <TouchableOpacity onPress={handleClose} style={styles.closeBtn}>
              <Text style={[styles.closeBtnText, { color: theme.text2 }]}>
                ✕
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.menuList}>
            {MENU_ITEMS.map((item, i) => (
              ...
              >
                ...
                <Text style={[styles.menuItemArrow, { color: theme.text3 }]}>
                  ›
                </Text>
              </TouchableOpacity>
            ))}
          ...
          <View style={styles.drawerFooter}>
            ...
            >
              ...
              <Text style={[styles.lockBtnText, { color: accent.primary }]}>
                Verrouiller l'app
              </Text>
            </TouchableOpacity>
