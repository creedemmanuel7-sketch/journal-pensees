  ...
  const handleChangePin = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        Alert.alert(
          'Succès',
          'Votre code PIN a été modifié et vos notes re-chiffrées.',
        );
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <View style={[styles.optionRow, { borderBottomWidth: 0 }]}>
            <Text style={{ fontSize: 28 }}>
              {getSeasonalEmoji(currentSeason)}
            </Text>
            <View style={{ flex: 1 }}>
          ...
          {Object.entries(ACCENT_LABELS).map(([key, val], i) => (
            <TouchableOpacity
              ...
              style={[
                styles.optionRow,
                { borderBottomColor: theme.border },
                i === Object.keys(ACCENT_LABELS).length - 1 && {
                  borderBottomWidth: 0,
                },
              ]}
            ...
            >
              ...
              <View
                style={[
                  ...
                  { borderColor: theme.border },
                  accentKey === key && {
                    borderColor: ACCENTS[key].primary,
                    backgroundColor: ACCENTS[key].primary,
                  },
                ]}
              >
        ...
        >
          <View
            style={[styles.previewHeader, { borderBottomColor: theme.border }]}
          >
            <Text style={[styles.previewTitle, { color: accent.primary }]}>
              Mes Pensées
            </Text>
            <Text style={[styles.previewSub, { color: theme.text3 }]}>
              CHIFFREMENT ACTIF
            </Text>
          </View>
            ...
            {[
              ...
              >
                <View
                  style={[
                    styles.previewDot,
                    { backgroundColor: accent.primary, opacity: 1 - i * 0.25 },
                  ]}
                />
        ...
        >
          <View style={[styles.optionRow, { borderBottomWidth: 0 }]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.optionDesc, { color: theme.text3 }]}>
                Élégante & italique pour les titres
              </Text>
            </View>
            <View
              style={[
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.optionDesc, { color: theme.text3 }]}>
                Re-chiffre toutes vos notes existantes
              </Text>
            </View>
          ...
          <View style={styles.optionRow}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.optionDesc, { color: theme.text3 }]}>
                Capture une photo après 3 échecs
              </Text>
            </View>
            <Toggle
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={[
                  styles.optionDesc,
                  { color: tutorialsReset ? accent.teal : theme.text3 },
                ]}
              >
                {tutorialsReset
                  ? '✓ Tutoriels réinitialisés — ils réapparaîtront'
                  : 'Relancer les guides contextuels sur chaque écran'}
              </Text>
            </View>
            <Text style={{ color: theme.text4 }}>❯</Text>
          </TouchableOpacity>
      ...
      <Modal visible={pinModalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          ...
          >
            <Text style={[styles.modalTitle, { color: accent.primary }]}>
              Nouveau Code PIN
            </Text>
            <Text style={[styles.modalDesc, { color: theme.text2 }]}>
              Le changement de PIN re-chiffrera toutes vos notes avec la
              nouvelle clé.
            </Text>
            <TextInput
              style={[
